                        ...
                        <div class="card-body">
                            <div class="row logo-headline">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-8" style="text-align: right !important; margin-bottom: 50px">
                                    <h1><strong>How can you</strong></h1>
                                    <h1><strong>help with conservation</strong></h1>
                                </div>
                            </div>
                            <div class="card-text text-center m-5">
                                <img class="round" src="imgs/collage4.png">
                                <br><br>
                               <ul class="paragraph" style="text-align: left; margin-left: 120px; ">
                                   <li style="margin-bottom: 10px">
                                       Provide food for butterflies by growing nectar-rich flowers in the spring and summer months.
                                   </li>
                                   <li style="margin-bottom: 10px">
                                       People without a garden can plant flowers at home in a window box or on the balcony.
                                   </li>
                                   <li style="margin-bottom: 10px">
                                       Leave fallen food on the ground like rotting pears, apples and berries.
                                   </li>
                                   <li style="margin-bottom: 10px">
