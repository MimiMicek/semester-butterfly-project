                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <h4 style="text-align: center;">
                                How long do you think a butterfly lives on average?
                            </h4>
                            <h5 style="text-align: center; margin-bottom: 30px;">*adjust the slide with the amount you think it fits</h5>
                            <div class="card-text text-center m-5">
                                <input id="ex21" type="text"
                                       data-provide="slider"
                                       data-slider-ticks="[1, 2, 3, 4, 5]"
                                       data-slider-ticks-labels='["1 day", "2 weeks", "1 month", "6 months","1 year"]'
                                       data-slider-min="1"
                                       data-slider-max="5"
                                       data-slider-step="1"
                                       data-slider-value="2"
                                ...
                                <div class="row">
                                    ...
                                    <div id="answer" class="col-xs-12 col-sm-6 col-md-8 answer float-right" style="text-align: right !important; margin-top: 40px;">
                                        <p style="text-align: center !important;margin-top: inherit">
                                            On average butterflies live <strong>2 - 3 weeks</strong> but there are specimens that live only 1 day and some specimens like the Common brimstone that can live up to a year.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="text-align: right !important;">
                                <a href="closer-look" style="text-align: center !important; margin-top: 50px" class="btn-next"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
