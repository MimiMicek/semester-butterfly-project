                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <h4 style="text-align: center;">
                                Butterflies also named Lepidoptera emerged from moths. When do you think the oldest group of Lepidoptera found, originates?
                            </h4>
                            ...
                            <div class="card-text text-center m-5">
                                <input id="ex21" type="text"
                                       ...
                                       data-slider-ticks-labels='["10 000 mil years ago", "50 000 mil years ago", "100 000 mil years ago", "300 000 mil years ago","500 000 mil years ago"]'
                                       data-slider-min="1"
                                       data-slider-max="5"
                                       data-slider-step="1"
                                       data-slider-value="2"
                            ...
                            <div style="text-align: right !important;">
                                <a href="facts-slider-2" style="text-align: center !important; margin-top: 50px" class="btn-next"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
