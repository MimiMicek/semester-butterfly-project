                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <h4 style="text-align: center;">
                                If increased up to 200 times, how do you think a butterfly wing would look?
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <label>
                                            ...
                                            <img style="width: 85%" src="imgs/textureA.png">
                                        </label>
                                    </div>
                                    <div class="col-sm">
                                        <label>
                                            <input type="radio" name="test" value="small" checked>
                                            <img style="width: 85%" src="imgs/textureB.png">
                                        </label>
                                    </div>
                                    <div class="col-sm">
                                        <label>
                                            <input type="radio" name="test" value="small" checked>
                                            <img style="width: 85%" src="imgs/textureC.png">
                                        </label>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div id="answer" class="col-xs-12 col-sm-6 col-md-8 answer float-right" style="text-align: right !important; margin-top: 40px; margin-left: 150px">
                                        <p style="text-align: center !important;margin-top: inherit">
                                            Most of a butterfly body is covered in <strong>scales (C)</strong>. Name <strong>Lepidoptera</strong>
                                            is derived from ancient <strong>Greek (lepís and pterón)</strong> which can be interpreted as <strong>"scaly winged"</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="text-align: right !important;">
                                <a href="closer-look-2" style="text-align: center !important; margin-top: 50px" class="btn-next"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
