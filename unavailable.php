                        ...
                        <div class="card-body">
                            <div class="row logo-headline">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-8" style="text-align: right !important; margin-bottom: 50px">
                                    <h1><strong>Unavailable?</strong></h1>
                                    <h1><strong>Why is that?</strong></h1>
                                </div>
                            </div>
                            <h4 style="text-align: center;">
                                You might be wondering at this point <strong>why were you not able to see all the stories</strong>.
                            </h4>
                            <div class="card-text text-center m-5">
                                <img class="round" src="imgs/collage3.png">
                                <br><br>
                                <div style="text-align: justify; margin-left: 40px; margin-right: 40px; padding-left: 40px; padding-right: 40px; ">
                                    <p class="paragraph">
                                        <strong>Many butterflies species are now endangered, threathen or vulnerable</strong>. As so there is a high risk that they will be soon not part of our ecosystem in the near feature, so unvailable.
                                    </p>
                                    <p class="paragraph">
                                        In Denmark alone, <strong>out of a total of 75 species</strong>, <strong>12 are already extict</strong> and <strong>35 are either threathen or vulnerable</strong>.
                                    </p>
                                    <p class="paragraph">
                                        Some of the reasons for the decline in species are the <strong>loss of habitat </strong>either due to <strong>agriculture</strong> and <strong>other human related practices</strong>,
                                        <strong>logging and forest area reduction, urbanisation, temperature rise, usage of pesticides and other chemicals</strong>.
                                    </p>
                                </div>
                                <br><br>
                                <img class="round" src="imgs/blueMorpho.png">
                                <br><br>
                                <div style="text-align: justify; margin-left: 40px; margin-right: 40px; padding-left: 40px; padding-right: 40px; ">
                                    <p class="paragraph">
                                        Blue Morpho’s wings properties of light reflexion were the inspiration for technological innovation of modern displays, but it is currently endangered and the decline is also due to over request from private collectors.
                                    </p>
                                </div>
                            </div>
