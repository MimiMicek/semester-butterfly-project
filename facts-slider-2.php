                        ...
                        <div class="card-body">
                            <div class="row logo-headline">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-8" style="text-align: right !important; margin-bottom: 50px">
                                    <h1><strong>Let's check</strong></h1>
                                    <h1><strong>some facts</strong></h1>
                                </div>
                            </div>
                            <h4 style="text-align: center;">
                                Lepidoptera order consists of 46 superfamilies and 126 families. How many species do you think are known?
                            </h4>
                            <h5 style="text-align: right; margin-bottom: 30px;">*adjust the slide with the amount you think it fits</h5>
                            <div class="card-text text-center m-5">
                                <input id="ex21" type="text"
                                       data-provide="slider"
                                       data-slider-ticks="[1, 2, 3, 4, 5]"
                                       data-slider-ticks-labels='["1 000", "10 000", "60 000", "100 000","180 000"]'
                                       data-slider-min="1"
                                       data-slider-max="5"
                                       data-slider-step="1"
                                       data-slider-value="2"
                                ...
                                <div class="row">
                                    <div style="text-align: left !important; margin-top: 100px; margin-left: 100px" class="col-xs-6 col-md-4">
                                        <button id="checkBtn" onclick="showAnswer()" style="" class="btn btn-success">Check answer</button>
                                    </div>
                                    <div id="answer" class="col-xs-12 col-sm-6 col-md-8 answer float-right" style="text-align: right !important; margin-top: 50px;">
                                        <p style="text-align: center !important;margin-top: inherit">
                                            Currently there are <strong>180 000 known species</strong> of Lepidoptera.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="text-align: right !important;">
                                <a href="facts-slider-3" style="text-align: center !important; margin-top: 50px" class="btn-next"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
