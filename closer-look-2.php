                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <h4 style="text-align: center;">
                                What part of the body butteflies use to taste with?
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <label>
                                            ...
                                            <img style="width: 85%" src="imgs/tasteA.png">
                                        </label>
                                    </div>
                                    <div class="col-sm">
                                        <label>
                                            <input type="radio" name="test" value="small" checked>
                                            <img style="width: 85%" src="imgs/tasteB.png">
                                        </label>
                                    </div>
                                    <div class="col-sm">
                                        <label>
                                            <input type="radio" name="test" value="small" checked>
                                            <img style="width: 85%" src="imgs/tasteC.png">
                                        </label>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div id="answer" class="col-xs-12 col-sm-6 col-md-8 answer float-right" style="text-align: right !important; margin-top: 20px; margin-left: 150px">
                                        <p style="text-align: center !important;margin-top: inherit">
                                            Butterflies taste with their <strong>feet (A)</strong>. They use both their <strong>feet and the antennas</strong>
                                            to smell which helps them find the <strong>right food and protects them from toxic substances</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
